...
export default () => {
    ...
    const ThemeTool = () => (
        ...
        <input type="checkbox" className="theme-switch__checkbox" onChange={() => changeThemeHandle()} checked={darktheme}/>
    ...
    const Burger  = () => {
      return (
        <div className="hamburger no-drag">
          <input className={`checkbox${!collapsed ? 'Checked' : 'UnChecked'} checkbox`} type="checkbox" onChange={() => handleChange()} checked={!collapsed} />
      ...
      >
        ...
        >
          <ProLayout
            ...
            token={{
              sider: {
                colorBgMenuItemSelected: antdToken.colorPrimaryTextActive + '29',
                colorTextMenuSelected: antdToken.colorPrimaryText,
