...
const Settings: React.FC = () => {
  ...
  const BgOption1 = () => {
    return (
      <div className='bg1' style={{ height: '100px' }}></div>
    );
  };
  const BgOption2 = () => {
    return (
      <div className='bg2' style={{ height: '100px' }}></div>
    );
  };
  const BgOption3 = () => {
    return (
      <div className='bg3' style={{ height: '100px' }}></div>
    );
  };
  ...
  const TabOne = () => {
    return (
      <>
        <Divider orientation='left' style={{ borderColor: '#4096ff', fontSize: '16px', fontWeight: 'bold' }}>深浅模式</Divider>
        <ThemeTool changeTheme={changeTheme} darkTheme={darktheme} />
        <Divider orientation='left' style={{ borderColor: '#4096ff', fontSize: '16px', fontWeight: 'bold', marginTop: '15px' }}>背景样式</Divider>
        <BgStyle />
      </>
    )
  }
