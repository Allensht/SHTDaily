...
const Home = () => {
    const intl = useIntl();
    const [magicName, setMagicName] = useState("SHTDaily | 你的日常助手");
    ...
    return (
        <>
            <div className="loader">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" height="64" width="64" className="inline-block svg">
